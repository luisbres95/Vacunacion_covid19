...
Tdw =timetable(T(1:1:(end-1))',1e-6*esq_dosis');
Wdw=retime(Tdw,"monthly","sum");
...
tsum=timetable(T(1:1:(end-1))',tp_dia(1:1:(end-1))');
Wsum=retime(tsum,"monthly","sum");
tp_sem=Wsum.Var1;
...
title('Avance Mensual | Personas Vacunadas | COVID-19 México')
